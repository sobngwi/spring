...
insert into contact (first_name, last_name, birth_date) values ('Alain', 'SOBNGWI', '1973-01-04');
...
insert into contact_tel_detail (contact_id, tel_type, tel_number) values (4, 'Mobile', '0671597605');
insert into contact_tel_detail (contact_id, tel_type, tel_number) values (4, 'Home',   '0171591605');
...
insert into contact_hobby_detail(contact_id, hobby_id) values (4, 'Swimming'); 
