...
public class ContactController {
    ...
    public void deleteUnknown(@PathVariable Long id) throws Exception {
        logger.info("Deleting deleteUnknown contact with id: " + id);
        Contact contact = contactService.findById(id);
        contactService.deleteUnknown(contact);
        logger.info("Unknown Contact deleted successfully");
